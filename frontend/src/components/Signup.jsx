...
const { name, value } = e.target;
  ...
  return (
    <div className="h-100% items-center flex justify-center px-5 lg:px-0">
      <div className="max-w-screen bg-white border shadow sm:rounded-lg flex justify-center flex-1">
            ...
            <div className="w-full flex-1 mt-8">
              <form className="mx-auto max-w-xs flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex gap-3 text-sm">
                   <label className="text-md font-bold text-blue-900">Gender:</label>
                  <label>
                   <input
